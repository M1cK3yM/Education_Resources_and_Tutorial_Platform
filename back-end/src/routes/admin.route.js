...
const { authorizeJwt, isAdmin, checkNotAdmin } = require("../middleware/auth.middleware");
...
router.post("/login", validateEmailandPassword, checkNotAdmin, authController.loginAccount);
